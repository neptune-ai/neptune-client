...
- Stop hanging indefinitely on wait when async data synchronization process is dead ([#X](https://github.com/neptune-ai/neptune-client/pull/X))
- Finish stop() faster when async data synchronization process dies ([#X](https://github.com/neptune-ai/neptune-client/pull/X))
