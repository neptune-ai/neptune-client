...
from neptune_old.internal.hardware.gauges.gpu import GpuMemoryGauge, GpuUsageGauge
...
from neptune_old.internal.hardware.resources.system_resource_info import SystemResourceInfo
