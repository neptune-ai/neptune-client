...
class Notebook(object):
    """It contains all the information about a Neptune Notebook
        ...
        Args:
            api_client (:class:`~neptune.ApiClient`): A ApiClient object
    ...
    """
    def __init__(self, api_client, project, _id, owner):
    ...
    def add_checkpoint(self, file_path):
        ...
        with open(file_path) as f:
            return self._api_client.create_checkpoint(self.id, os.path.abspath(file_path), f)
    ...
    def get_path(self):
        ...
        """
        return self._api_client.get_last_checkpoint(self._project, self._id).path
    ...
    def get_name(self):
        ...
        """
        return self._api_client.get_last_checkpoint(self._project, self._id).name
