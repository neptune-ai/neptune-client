...
- Connection mode `debug` renamed to `disabled` ([#1844](https://github.com/neptune-ai/neptune-client/pull/1844))
- `proxies` parameter removed ([#1842](https://github.com/neptune-ai/neptune-client/pull/1842))
