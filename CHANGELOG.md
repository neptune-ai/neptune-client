...
### Features
- Added `neptune.typing` module with `Assignable` type to handle proper type checking across integrations ([#1280](https://github.com/neptune-ai/neptune-client/pull/1280))
