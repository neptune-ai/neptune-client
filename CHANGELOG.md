...
- `fetch_runs_table(...)`, `fetch_models_table(...)` and `fetch_model_versions_table(...)` now queries only non-trashed ([#1028](https://github.com/neptune-ai/neptune-client/pull/1028))
