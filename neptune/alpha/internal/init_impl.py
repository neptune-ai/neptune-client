...
def init(
        ...
        capture_namespace: str = "monitoring",
    ...
    verify_type("capture_namespace", capture_namespace, str)
    ...
    if capture_hardware_metrics:
        if HardwareMetricReportingJob.requirements_installed():
            background_jobs.append(HardwareMetricReportingJob(attribute_namespace=capture_namespace))
        else:
        ...
        background_jobs.append(PingBackgroundJob())
    if capture_stdout:
        background_jobs.append(StdoutCaptureBackgroundJob(attribute_name="{}/stdout".format(capture_namespace)))
    if capture_stderr:
        background_jobs.append(StderrCaptureBackgroundJob(attribute_name="{}/stderr".format(capture_namespace)))
