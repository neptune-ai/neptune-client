...
class Run(MetadataContainer):
    ...
    def __init__(
        ...
        *,
        ...
        mode: Optional[Literal["async", "sync", "offline", "read-only", "debug", "subprocess"]] = None,
        name: Optional[str] = None,
        description: Optional[str] = None,
        tags: Optional[Union[List[str], str]] = None,
        source_files: Optional[Union[List[str], str]] = [],
        ...
        git_ref: Optional[Union[GitRef, GitRefDisabled, bool]] = GitRef.DISABLED,
