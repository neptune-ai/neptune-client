...
class TestHuggingFace(BaseE2ETest):
    ...
    #         training_args = self._trainer_default_attributes.copy()
    #         training_args['args'] = TrainingArguments(
    #             "model", report_to=[], num_train_epochs=500, learning_rate=0.5, save_steps=500, save_strategy='steps',
    #             load_best_model_at_end=False, evaluation_strategy='steps', eval_steps=500,
    #         )
