...
### Fixes
- Fix issue that prevented waiting for subprocesses to finish after receiving stop signal from backend ([#XXX](https://github.com/neptune-ai/neptune-client/pull/XXX));
