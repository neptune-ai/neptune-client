...
class Experiment(Handler):
    ...
    def _prepare_sys_namespace(self):
        self._structure.set(["sys", "id"], StringAttr(self, ["sys", "id"]))
        self._structure.set(["sys", "owner"], StringAttr(self, ["sys", "owner"]))
        self._structure.set(["sys", "name"], StringAttr(self, ["sys", "name"]))
        self._structure.set(["sys", "description"], StringAttr(self, ["sys", "description"]))
        self._structure.set(["sys", "hostname"], StringAttr(self, ["sys", "hostname"]))
        self._structure.set(["sys", "creation_time"], StringAttr(self, ["sys", "creation_time"]))
        self._structure.set(["sys", "modification_time"], StringAttr(self, ["sys", "modification_time"]))
        self._structure.set(["sys", "size"], FloatAttr(self, ["sys", "size"]))
        self._structure.set(["sys", "tags"], StringSetAttr(self, ["sys", "tags"]))
        self._structure.set(["sys", "notebook", "id"], StringAttr(self, ["sys", "notebook", "id"]))
        self._structure.set(["sys", "notebook", "name"], StringAttr(self, ["sys", "notebook", "name"]))
        self._structure.set(["sys", "notebook", "checkpoint", "id"], StringAttr(self, ["sys", "notebook", "checkpoint", "id"]))
        self._structure.set(["sys", "notebook", "checkpoint", "name"], StringAttr(self, ["sys", "notebook", "checkpoint", "name"]))
